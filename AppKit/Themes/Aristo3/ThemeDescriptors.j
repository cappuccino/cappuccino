...
+ (CPComboBox)themedComboBox
{
    ...
    [
        ...
        [@"content-inset",              CGInsetMake(2.0, 17.0, 0, 2),              [CPThemeStateControlSizeSmall, CPThemeStateBezeled, CPComboBoxStateButtonBordered]],
        ...
        [@"content-inset",              CGInsetMake(2.0, 17.0, 0, 2),              [CPThemeStateControlSizeMini, CPThemeStateBezeled, CPComboBoxStateButtonBordered]],
