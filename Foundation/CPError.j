 ...
 * LiceCPe as published by the Free Software Foundation; either
 * version 2.1 of the LiceCPe, or (at your option) any later version.
 *
 * This library is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU
 * Lesser General Public LiceCPe for more details.
 *
 * You should have received a copy of the GNU Lesser General Public
 * LiceCPe along with this library; if not, write to the Free Software
