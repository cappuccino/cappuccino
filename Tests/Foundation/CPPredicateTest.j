...
- (id)init
{
    ...
    if (self != nil)
    {
        ...
        var keys = [CPArray arrayWithObjects:@"Name",@"Age",@"Children",nil];
        objects = [CPArray arrayWithObjects:@"John",[CPNumber numberWithInt:34],[CPArray arrayWithObjects:@"Kid1", @"Kid2", nil],nil];
        
        d = [CPDictionary dictionaryWithObjects:objects forKeys:keys];        
        [dict setObject:d forKey:@"Record1"];
    
        objects = [CPArray arrayWithObjects:@"Mary",[CPNumber numberWithInt:30],[CPArray arrayWithObjects:@"Kid1", @"Girl1", nil],nil];
...
- (void)testExpressionsInit
{
    ...
    var expression_collection = [CPExpression expressionForConstantValue:[CPArray arrayWithObjects:@"a",@"b",@"d",nil]];
    ...
    var expression_function = [CPExpression expressionForFunction:@"sum:" arguments:[CPArray arrayWithObjects:expression_num,expression_num,nil]];
    ...
    var expression_aggregate = [CPExpression expressionForAggregate:[CPArray arrayWithObjects:expression_str,expression_num,expression_function,nil]];
...
{
    var function_exp = [CPExpression expressionForFunction:"sum:" arguments:[CPArray arrayWithObjects:[CPExpression expressionForConstantValue:1],[CPExpression expressionForConstantValue:2],[CPExpression expressionForConstantValue:3],nil]];
...
- (void)testCompoundPredicate
{
    ...
    var pred = [[CPCompoundPredicate alloc] initWithType:CPAndPredicateType subpredicates:[CPArray arrayWithObjects:predOne,predTwo,nil]];
...
// TEST integer
    ...
    predicate = [CPPredicate predicateWithFormat: @"%K BETWEEN %@", @"Record1.Age", [CPArray arrayWithObjects:[CPNumber numberWithInt: 20], [CPNumber numberWithInt:40], nil]];
    [self assertTrue:[predicate evaluateWithObject:dict] message:[predicate description] + " should be true"];
