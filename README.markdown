...
To develop Cappuccino applications, all you need is a simple text editor. However, Cappuccino's integrated Xcode support leverages the eases of Cocoa development for the web. 
